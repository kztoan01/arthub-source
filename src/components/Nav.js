...
function Nav(props) {
    return (
        <>
            <header class="bg-white">
                ...
                <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    ...
                    <Link to="/"><a href="#" class="-m-1.5 p-1.5">
                            <span class="sr-only">ArtHub</span>
        ...
        --> */}
                        ...
                        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Instructor</a>
                        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">My learning</a>
                    ...
                    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                        <Link to="/login"><a href="#" class="text-sm font-semibold leading-6 text-gray-900 mr-5">{props.login}</a></Link>
                        <Link to="/signup"><a href="#" class="text-sm font-semibold leading-6 text-gray-900">{props.signup}</a></Link>
                    </div>
                </nav>
            </header>
        </>
