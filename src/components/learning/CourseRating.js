...
export default function CourseRating() {
    ...
    formAddRating.append('rate', rated);
    ...
    const stuRating = thisCourseRating?.filter((ann) => ann?.accountId != thisCourse?.accountId)
    const isRated = thisCourseRating?.find((rate) => rate?.accountId == thisAccount?.id)
    //edit rating
    ...
    return (
        <>
            <div className="isolate bg-white px-6 py-24 sm:py-0 lg:px-24 ">
                ...
                {thisAccount?.roleId == 2 ?
                    <article className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        {isRated ? <>
                            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                <h2 className="text-xl font-medium text-gray-900">Your feedback</h2>
                                <div className="mt-4 space-y-6">
                                    <article key={isRated.id} className="flex max-w-xl flex-col items-start justify-between">
                                        <div className="flex items-center gap-x-4 text-xs mt-4">
                                            <time dateTime={isRated.timeRate} className="w-20 text-gray-500">
                                                {isRated.timeRate.split('T')[0]}
                                            </time>
                                            {/* <a
                                        ...
                                        <div className="group relative">
                                            ...
                                            <p className="mt-5 line-clamp-8 text-sm leading-6 text-gray-600">{isRated.comment}</p>
                                        </div>
                                        <div className="relative mt-8 flex items-center gap-x-4">
                                            <img src={findAccountById(isRated?.accountId)?.image ? linkImg + findAccountById(isRated?.accountId)?.image : defaultImg} alt="" className="h-10 w-10 rounded-full bg-gray-50" />
                                            <div className="text-sm leading-6">
                                                <p className="font-semibold text-gray-900">
                                                    ...
                                                    >
                                                        <span className="absolute inset-0" />
                                                        {findAccountById(isRated?.accountId)?.firstname + " " + findAccountById(isRated?.accountId)?.lastname}
                                                    </a>
                                                </p>
                ...
                <div className="bg-white py-24 sm:py-8">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <h2 className="text-xl font-medium text-gray-900">Student feedback</h2>
                        <div className="mt-4 space-y-6">
                            {stuRating?.slice(0).reverse().map((post) => (
                                    ...
                                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                        <div className="sm:flex sm:items-start">
                                            ...
                                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        Clicking Accept means permanently deleting the rating.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
