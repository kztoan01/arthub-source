      ...
      {banner == true ? <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          <p className="text-sm leading-6 text-gray-900">
            <strong className="font-semibold">ArtHub 2023</strong><svg viewBox="0 0 2 2" className="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true"><circle cx="1" cy="1" r="1" /></svg>Register for the course from August 22 - September 22 to receive the best deals.
          </p>
          <Link to="/login">
                          ...
                          <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
                            ...
                            <div className="items-center mt-6 grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                              ...
                              <div className="mt-6 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                                ...
                                <Link to={`/${findCourseById(sender?.courseId)?.id}`}><div className="group relative">
